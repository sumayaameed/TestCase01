...
public class SwitchToWindows {
	...
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//a[1]//button[1]"))));
		driver.findElement(By.xpath("//a[1]//button[1]")).click();
		...
		System.out.println(driver.findElement(By.xpath("//a[1]//button[1]")).getText());
